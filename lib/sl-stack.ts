...
export class SlStack extends Stack {
  constructor(scope: Construct, id: string, mongoDBDatabase: string = 'dev', props?: StackProps) {
    ...
    const thumbnailGenerator = new PythonFunction(this, 'ThumbnailGenerator', {
      description: 'Generates thumbnails for each clip generated by CCCFinder',
      runtime: Runtime.PYTHON_3_8,
      handler: 'handler',
      index: 'handler.py',
      entry: './lambdas/thumbnailgenerator',
      memorySize: 1280,
    ...
    // new SnsEventSource(thumbnailGeneratorTopic).bind(clipFinder);
