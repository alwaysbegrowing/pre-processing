...
export class SlStack extends Stack {
  constructor(
    ...
    const thumbnailGenerator = new DockerImageFunction(
      this,
      "ThumbnailGenerator",
      {
        code: DockerImageCode.fromImageAsset("./lambdas/thumbnailgenerator"),
        description:
          "Generates thumbnails for each clip generated by ClipFinder",
    ...
    const twitchSecret = Secret.fromSecretAttributes(
      this,
    ...
    const automaticClipGenerator = new PythonFunction(
      this,
    ...
    const generateAutomaticClips = new LambdaInvoke(
      this,
    ...
    const generateManualClips = new LambdaInvoke(
      this,
      "Generate Manual Clips",
      {
    ...
    const generateThumbnails = new LambdaInvoke(
      this,
